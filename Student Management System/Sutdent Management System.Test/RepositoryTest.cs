...
namespace Sutdent_Management_System.Test
{
    [TestFixture]
    public class RepositoryTest
    {
        private const string _filePath = @"C:\Data\StudentManagementSystem\StudentTest.txt";
        private const string _originalData = @"C:\Data\StudentManagementSystem\StudentTestSeed.txt";
